  ...
  <body class="text-center">
    ...
    <main class="form-signin">
      <form action="cadastro.php" method="post">
        ...
        <?php 
          if(isset($_COOKIE['erro_register'])){
          ?>
          <div class="alert alert-danger" id="alert-input" role="alert">
            <?php echo $_COOKIE['erro_register']; ?>
          </div>
          <?php
          }
        ?>
        ...
        <button class="w-100 btn btn-lg btn-primary" type="submit" name="acao">Criar conta</button>
